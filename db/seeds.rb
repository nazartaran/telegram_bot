...
[
  ...
  { body: "Напишіть по-грецьки *'мистецтво побудови військ'*.",
    answers: ['тактика', 'tactic'], for_tournament: true, round: 1 },
  ...
  { body: "У 2000 році молодий банкір з Уолл-Стріт одягнув на зустріч зі своїм колегою прозоре пластикове пальто, щоб захистити свій одяг від *ЦЬОГО*. У 2013 році судовий психіатр з Меріленда надів схоже пальто на зустріч зі своїм колегою з тією ж метою. Від чого вони хотіли захистити одяг?",
    answers: ['кров', 'кровь', 'blood'], for_tournament: true, round: 5 }
]
Question.delete_all
